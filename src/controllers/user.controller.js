...
const setAvatar = asyncHandler(async (req,res)=>{
    ...
    const Avatar = await req.body.image;
    ...
    return res
    .status(200)
    .json(new ApiResponse(200,user,"Avatar Image Added Succeefully"))
});
...
const getAllUsers = asyncHandler(async (req,res)=>{
    try {
        ...
        throw new ApiError(401, error?.message || "Unable to fetch User Data!!");
    }
})
